...
export class Backend implements backendInterface {
    ...
    async addOffer(arg0: string, arg1: PointsReward, arg2: string): Promise<OfferId> {
        if (this.processError) {
            try {
                const result = await this.actor.addOffer(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addPoints(arg0: Principal, arg1: Points): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteOffer(arg0: OfferId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async redeemOffer(arg0: Principal, arg1: OfferId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.redeemOffer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
